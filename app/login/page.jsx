  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 pb-safe">
      <div className="w-full max-w-[400px] space-y-5">
        ...
        {/* LINE */}
        <a
          href="https://line.me/R/ti/p/@825xfxhu"
          className="w-full flex items-center justify-center gap-2.5 bg-[#06C755] hover:bg-[#05b04a] text-white py-3.5 rounded-xl text-sm font-medium transition"
        >
        ...
        <p className="text-xs text-gray-600 text-center -mt-2">
          กดแล้วเพิ่มเพื่อน LINE OA เพื่อใช้งานผ่าน LINE
        </p>
